...
created: 2026-07-15
description: "Design has always been one of the areas where AI struggles to match human ability. But most people still misunderstand what designing with A..."
tags:
  - "clippings"
---
![Image](https://pbs.twimg.com/media/HNDvPf3WUAASbRg?format=jpg&name=large)
...
AI is there to help you execute. Here is the process in simple terms:
...
Once you have direction, start collecting references. A strong source is [Mobbin](https://mobbin.com/?referrer_workspace_id=02ebbc50-20f0-42fb-8222-a66cb42b26b0).
...
also: Do not copy entire designs. Combine ideas into something that fits your product.

## Map the Structure

Now define what you actually need to build. For a website:
...
Each section needs clear content. For example, a hero needs:
...
Now you start building. Take individual ideas from your references and adapt them. Instead of saying: “Build me a full website”
...
SVG Generation Use [Quiver](https://app.quiver.ai/explore) to create SVGs. SVGs allow for better animations because elements are separate.

Video Use tools like [Google Flow](https://labs.google/fx/tools/flow). Video can enhance:

- Hero sections
- Backgrounds
- Product demos

Image Libraries Use platforms like [Lummi](https://www.lummi.ai/) when needed. Just make sure images match your brand.

Layering Use background removal and layering to add:
