...
created: 2026-07-26
description: "Most people who try to build a multi-step agent end up with a straight line. Step one, step two, step three - each waiting politely for the ..."
tags:
  - "clippings"
---
![Image](https://pbs.twimg.com/media/HNqZMWeWYAAqsw-?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HNqdriNXYAAJlBB?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HNqlJ68XUAAe-PB?format=png&name=large)
...
![Image](https://pbs.twimg.com/media/HNql8XpXcAA5-2h?format=png&name=large)
...
![Image](https://pbs.twimg.com/media/HNqmfUhXIAA_Y70?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HNqnSStWIAAPvab?format=png&name=large)
...
![Image](https://pbs.twimg.com/media/HNqn3q8XoAAXCdJ?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HNqoqYPWcAEYbIc?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HNqpB0FWgAAM74x?format=png&name=large)
...
![Image](https://pbs.twimg.com/media/HNqpYomX0AAPw7z?format=png&name=large)
...
![Image](https://pbs.twimg.com/media/HNqp1zkW8AA4fhg?format=png&name=large)
...
That’s already partly true: a thunk that throws inside parallel() resolves to null, so eight good agents still return while one bad one drops out. Your .filter(Boolean) is the containment. Design every fan-in to tolerate missing inputs rather than assume a full set.

![Image](https://pbs.twimg.com/media/HNqqdlGXcAAYFV3?format=png&name=large)

The subtler failure is nodes stepping on each other. When agents write files in parallel, they can collide. The fix is isolation: "worktree" - each agent runs in its own git worktree, does its work in a sandbox, and merges cleanly. Reach for it only when nodes actually write in parallel. it’s the seatbelt for the one topology that needs it, not a default tax on every run.
...
![Image](https://pbs.twimg.com/media/HNqrFflXAAEGQxk?format=png&name=large)
...
![Image](https://pbs.twimg.com/media/HNqrj4UWYAAvHC0?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HNqr10sW0AAFINc?format=png&name=large)
...
![Image](https://pbs.twimg.com/media/HNqsMKpXMAAB09_?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HNqtS-UXkAAAKzv?format=png&name=large)
